...
import left from '../images/Vector4.svg'
import right from '../images/Vector3.svg'
...
const Main = () =>{
    ...
    const [nameError, setNameError] = useState("Некоректные данные")
    // const [isver, setIsver] = useState()
    ...
    const handleSubmit = (e) =>{
        if(number.length < 1 || text.length < 1){
            setNameError("Некоректные данные")
            alert("Заполните обязательные поля! номер или текст сообщения")
            console.log("Заполните обязательные поля! номер или текст сообщения")
        } else {
    ...
    function SampleNextArrow(props) {
        ...
        return (
            <div>
            {  (windowWidth.current) > 1286 &&

                <div   
                className={className}
                style={{ ...style, display: "block", background: "white", padding: "20px", margin: "0 100px 0 0", zIndex:"10", borderRadius:'20px', boxShadow:'0px 8px 16px 0px rgba(0,0,0,0.2)' }}
                onClick={onClick}
                >

                <div
                style={{ ...style, display: "block", position:"absolute", margin:"-25px 0 0 -8px", filter:"brightness(0)"}}
                >   
      ...
      function SamplePrevArrow(props) {
        ...
        return (
            <div>
                ...
                <div
                    className={className}
                    style={{ ...style, display: "block", background: "white", padding: "20px", margin: "0 0 0 100px", zIndex:"10", borderRadius:'20px', boxShadow:'0px 8px 16px 0px rgba(0,0,0,0.2)' }}
                    onClick={onClick}
                >
                    <div
                    style={{ ...style,
                        display: "block", 
                        position:"absolute", margin:"-25px 0 0 -8px", filter:"brightness(0)"}} 
                    >
                        <img
                        ...
                        style={
                            ...
                            isShown ? {...style, width:"30px", height:"30px", filter:"brightness(0)"} : {...style, width:"30px", height:"30px"}
                                ...
                                <div className={styles.info_contact}>
                                    ...
                                    <div  className={styles.flex}>
                                        ...
                                        <div className={styles.flex_l}>
                                            ...
                                            <p className={styles.text_info}><a href="#">Мы на ЯндексMap</a></p>
                                        </div>
                                    </div>
                                    <div  className={styles.flex}>
                                        <div className={styles.left_zvon}>
                            ...
                            <div className={styles.form}>
                                ...
                                <div className={styles.flex_p}>
                                    ...
                                    <div className={styles.form_telef}>
                                        ...
                                        <input 
                                        type="tel"  
                                        placeholder="Пример +7-657-342-67-98"
                                        name="tel" 
                                        value={number}
